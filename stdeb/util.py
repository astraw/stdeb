...
class DebianInfo:
    ...
    def __init__(self,
                 ...
                 installed_egg_info_dirname=NotGiven,
                 ):
        ...
        if installed_egg_info_dirname is NotGiven: raise ValueError("installed_egg_info_dirname must be supplied")
        ...
        debinfo.installed_egg_info_dirname = installed_egg_info_dirname
...
INSTALLED_EGG_INFO_DIR=%(installed_egg_info_dirname)s
